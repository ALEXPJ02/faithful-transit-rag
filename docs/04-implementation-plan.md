...
| Prediction: baseline + model training | **Done** — `transit-train`; naive persistence written first. Test MAE 16.02 s vs baseline 18.17 s, **MASE 0.881** (14 service dates to 2026-09-16) ([`08-evaluation-plan.md`](./08-evaluation-plan.md) §3 still quotes the earlier 7-day run) |
